...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            ...
            <?php echo  \app\core\Form::beginForm("productUpdateProcess", "post")?>
            ...
            <div class="row">
                <div class="col-md-6 border-right">
                    ...
                    <div class="form-group">
                        <?php echo  \app\core\Form::field($params, 'typeOfBook', 'text')?>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" placeholder="Description ..."><?php echo $params->description; ?></textarea>
                    </div>
