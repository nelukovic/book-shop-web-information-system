        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/customerCreate" class="btn btn-success">Create new</a>
                </div>
            </div>
            <div class="card-header">
                <div class="card-title">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-condensed">
                            ...
                            <tr>
                                ...
                                <th class="border-top-0 text-center">Address</th>
                                <th class="border-top-0 text-center">Number</th>
...
<script>
    $(document).ready(function (){
        ...
        var url = "/customersJSON";
        var numberOfPage = 0;
        var numberOfRows = $("#numberOfRows").val();
        var search = $("#search").val();
        var moreData = true;

        loadMoreCustomerData($("#tableBody"), $("#progress"), $("#loadMoreBtn"), url, numberOfPage, numberOfRows, search);
        numberOfPage++;
