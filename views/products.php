        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/productCreate" class="btn btn-success">Create new</a>
                </div>
            </div>
            <div class="card-header">
                <div class="card-title">
                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-condensed">
                            <thead>
                                <tr>
                                    <th class="border-top-0 text-center">Book Name</th>
                                    <th class="border-top-0 text-center">Type Of Book</th>
...
<script>
    $(document).ready(function (){
        ...
        loadMoreProductsData( $("#tableBody"), $("#loadMoreBtn"), $("#progress"), url, numberOfPage, numberOfRows, search);
        numberOfPage++;
