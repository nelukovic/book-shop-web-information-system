        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form action="importCustomerJsonProcess" method="post" enctype="multipart/form-data">
                        <input type="file" name="importJson" id="importJson" accept="application/json"/>
                        <button type="submit" class="btn btn-info">Submit JSON</button>
                    </form>
                </div>

            </div>
            <?php echo \app\core\Form::beginForm("customerCreateProcess", "post") ?>
            ...
            <div class="row">
                <div class="col-md-6 border-right">
                    ...
                    <div class="form-group">
                        <?php echo \app\core\Form::field($params, 'number', 'text') ?>
                    </div>
                    <div class="form-group">
                        <?php echo \app\core\Form::field($params, 'address', 'text') ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
