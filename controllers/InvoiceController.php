...
class InvoiceController extends Controller
{
    ...
    public function invoicesActive()
    {
        $model = new InvoiceModel();

        $dbData = $model->invoiceActive();
    ...
    /**
     * Edit one object from table invoice - get method
     */
    ...
    /**
     * Delete one object from table invoice - get method
     */
    public function delete()
    {
        ...
        echo $this->view("invoiceDelete", "main", $model);
    }
